...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->flag_count_lbl->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 24, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
			...
			this->flag_count_lbl->Size = System::Drawing::Size(86, 46);
			...
			this->timer_lbl->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 24, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->timer_lbl->Size = System::Drawing::Size(86, 46);
			...
			this->back_lbl->Click += gcnew System::EventHandler(this, &MyForm::back_lbl_Click);
			// 
			// MyForm
			// 
...
#pragma endregion
	...
	public: void initializeGame(int cols, int rows, int Cell_size, int Mines) {
		...
		srand(time(0));
		//time is record of since pc 1st turned on
	...
	private: void game_over(int x, int y) {
		is_game_over = true;
		timer->Enabled = false;
		//STOPS TIMER , CROSSES FLAG AND EXPOSES MINES
...
private: System::Void back_lbl_Click(System::Object^ sender, System::EventArgs^ e) {
}
};
}
